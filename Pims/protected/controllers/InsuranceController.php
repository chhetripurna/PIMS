...
class InsuranceController extends Controller
{
	...
	{
		Yii::trace('in actionView()', 'info');
		$this->render('/site/billing',array(
			'model'=>$this->loadPatient($id),
		));
	}
	...
	public function actionCreate($pID)
	{
		...
		} while(Insurance::model()->findByPk($rand));
			
		$model->insuranceID=$rand;
		...
		if(isset($_POST['Insurance']))
		{
			...
			if($model->save())
			{
				$patient = $this->loadPatient($pID);
				$patient->save();
				Yii::trace('after patient save', 'info');
				$this->redirect(array('/site/billing','id'=>$model->patientID));
			}
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Insurance']))
		{
			$model->attributes=$_POST['Insurance'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->insuranceID));
		}
