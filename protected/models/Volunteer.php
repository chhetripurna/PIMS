...
/**
 * This is the model class for table "Pims.Volunteer".
 *
 * The followings are the available columns in table 'Pims.Volunteer':
...
class Volunteer extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('volunteerID, firstName, lastName', 'required'),
			array('volunteerID, loginName', 'length', 'max'=>7),
